...
Swift 5.10 or later is installed.
...
| endpoint| The endpoint used to access OSS. | withEndpoint("oss-cn-hangzhou.aliyuncs.com")
...
| httpProtocol | HTTP protocol, default to HTTPS | withHttpProtocal(.https)
...
```
***note：GetObjectToFile supports macOS 12.0, iOS 15.0, watchOS 8.0, tvOS 15.0 and above versions.***
